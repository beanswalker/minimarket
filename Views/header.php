...
<html>
  <head>
    ...
    <title>BeansWalker | Poject!!:...</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>BW</b>Business</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>BW-Business</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="../Public/dist/img/user_skull3.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">Beans Walker</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                      <img src="../Public/dist/img/user_skull3.png" class="img-circle" alt="User Image">
                    <p>
                      BeansWalker - Web-Developer
